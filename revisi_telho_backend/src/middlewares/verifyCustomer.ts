...
export const verifyAddCustomer = (request: Request, response: Response, next: NextFunction) => {
...
export const verifyEditCustomer = (request: Request, response: Response, next: NextFunction) => {
    /** validate a request body and grab error if exist */
